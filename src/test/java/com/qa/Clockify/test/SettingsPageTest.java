...
public class SettingsPageTest {
	...
	public void verifyWorkSpaceName() {
		System.out.println("Workspace name is : " +sp.checkWorkSpaceName());
		Assert.assertEquals(sp.checkWorkSpaceName(),SiteConstants.WORKSPACENAME);
	}
	...
	public void verifyUploadPhoto() {
		Assert.assertTrue(sp.doUploadPhoto());
	}
